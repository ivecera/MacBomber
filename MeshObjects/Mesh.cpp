...
void Mesh::configureTexture0(int index)
{
...
void Mesh::configureTexture1(int index)
{
...
void Mesh::drawVBO()
{
	...
	glDrawRangeElements(GL_TRIANGLES, 0, m_nIndices, m_nIndices,
